...
**สถานะ:** เผยแพร่รายละเอียดขั้นตอนในสัปดาห์ที่ 7

## ภาพรวม

ออกแบบ RESTful endpoint แบบ CRUD กำหนด HTTP status code, validation, error response และทดสอบด้วย Postman หรือ Thunder Client.
