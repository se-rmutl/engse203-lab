# LAB 04 — React Components, Props & State

**สัปดาห์ที่ 4** · หน่วยที่ 2 การพัฒนาส่วนติดต่อผู้ใช้ด้วย React.js  
**รูปแบบงาน:** รายบุคคล  
**CLO ที่เกี่ยวข้อง:** CLO3  
**การประเมิน:** A2 Weekly LAB  
**สถานะ:** เผยแพร่รายละเอียดขั้นตอนในสัปดาห์ที่ 4

## ภาพรวม

เริ่มต้น React application และแยก UI เป็น component ฝึก JSX, props, state, event handler และการส่งข้อมูลระหว่าง component.
