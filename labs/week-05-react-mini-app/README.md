# LAB 05 — React Routing, Data Fetching & Front-end Mini App

**สัปดาห์ที่ 5** · หน่วยที่ 2 การพัฒนาส่วนติดต่อผู้ใช้ด้วย React.js  
**รูปแบบงาน:** รายบุคคล  
**CLO ที่เกี่ยวข้อง:** CLO3  
**การประเมิน:** A2 Weekly LAB  
**สถานะ:** เผยแพร่รายละเอียดขั้นตอนในสัปดาห์ที่ 5

## ภาพรวม

พัฒนา Front-end mini application ที่มี routing, form, data fetching จาก mock data หรือ API ตัวอย่าง และจัดทำ README สำหรับผู้ใช้.
