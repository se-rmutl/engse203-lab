# LAB 09 — SQLite & SQL CRUD with Node.js

**สัปดาห์ที่ 10** · หน่วยที่ 4 ฐานข้อมูลและการบูรณาการระบบ Full-Stack  
**รูปแบบงาน:** รายบุคคล  
**CLO ที่เกี่ยวข้อง:** CLO5  
**การประเมิน:** A2 Weekly LAB  
**สถานะ:** เผยแพร่รายละเอียดขั้นตอนในสัปดาห์ที่ 10

## ภาพรวม

ออกแบบ data model ขนาดย่อม ใช้ SQLite และ SQL CRUD ร่วมกับ Node.js โดยเน้น parameterized query และการจัดการข้อมูลอย่างปลอดภัย.
