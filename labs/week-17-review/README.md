# ทบทวนบทเรียนและ Error Clinic

**สัปดาห์ที่ 17** · ทบทวนผลลัพธ์การเรียนรู้  
**รูปแบบงาน:** รายบุคคล  
**CLO ที่เกี่ยวข้อง:** CLO1–CLO7  
**การประเมิน:** Formative review  
**สถานะ:** ใช้สำหรับทบทวนและเตรียมสอบปลายภาค

## ภาพรวม

สรุปองค์ประกอบ Full-Stack ทบทวนข้อผิดพลาดที่พบบ่อย วิเคราะห์ code/API/database/test และเตรียมตัวสำหรับการประเมินปลายภาค.
