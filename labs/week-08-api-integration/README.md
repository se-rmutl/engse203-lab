# LAB 08 — API Contract, CORS & Front-end Integration

**สัปดาห์ที่ 8** · หน่วยที่ 3 การพัฒนาส่วนหลังและบริการ RESTful API ด้วย Node.js  
**รูปแบบงาน:** รายบุคคล  
**CLO ที่เกี่ยวข้อง:** CLO4, CLO6  
**การประเมิน:** A2 Weekly LAB  
**สถานะ:** เผยแพร่รายละเอียดขั้นตอนในสัปดาห์ที่ 8

## ภาพรวม

จัดทำ API contract, ตั้งค่า CORS/configuration/logging และเชื่อม Front-end เข้ากับ Back-end เพื่อแสดงข้อมูลจาก API จริง.
